...
const CityBusRoute = ({ origin, destination }: CityBusRouteProps) => {
  ...
  return (
    <View style={styles.container}>
      <FontText fontWeight="600" style={{ color: colors.dark.contrast }}>{origin}</FontText>
      <CaretRightIcon style={styles.icon} width={16} height={16}
                      fill={colors.light.gray200} />
      <FontText fontWeight="600" style={{ color: colors.dark.contrast }}>{destination}</FontText>
    </View>
  );
};
